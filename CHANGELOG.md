...
## [5.0.0](https://codefloe.com/celema/dev/src/tag/5.0.0) (2026-07-18)
...
## [4.2.0](https://codefloe.com/celema/dev/src/tag/4.2.0) (2026-05-13)

### Changed

- Pin mago version to v1.26.0.

## [4.1.0](https://codefloe.com/celema/dev/src/tag/4.1.0) (2026-05-12)

### Added

- Shared markdownlint config

## [4.0.0](https://codefloe.com/celema/dev/src/tag/4.0.0) (2026-05-08)

### Breaking Changes

- Rename package metadata, root namespace, repository URLs, homepage, and contact email to Duon.

## [3.0.1](https://codefloe.com/celema/dev/src/tag/3.0.1) (2026-04-29)

### Added

- Add Mago configuration.
...
- Replace the ambiguous `isset()` argument check in `DocsTestRunner` with an explicit null check.

## [3.0.0](https://codefloe.com/celema/dev/src/tag/3.0.0) (2026-03-21)
...
## [2.5.0](https://codefloe.com/celema/dev/src/tag/2.5.0) (2026-01-30)
...
## [2.4.1](https://codefloe.com/celema/dev/src/tag/2.4.1) (2026-01-30)

### Changed

- Update Psalm requirement to `^6.15`.

## [2.4.0](https://codefloe.com/celema/dev/src/tag/2.4.0) (2026-01-29)
...
## [2.3.0](https://codefloe.com/celema/dev/src/tag/2.3.0) (2026-01-28)
...
## [2.2.0](https://codefloe.com/celema/dev/src/tag/2.2.0) (2026-01-28)
...
## [2.1.0](https://codefloe.com/celema/dev/src/tag/2.1.0) (2026-01-27)
...
## [2.0.0](https://codefloe.com/celema/dev/src/tag/2.0.0) (2026-01-25)
...
## [1.1.7](https://codefloe.com/celema/dev/src/tag/1.1.7) (2025-04-01)

### Changed

- Update php-cs-fixer requirement to ^3.75.0

## [1.1.6](https://codefloe.com/celema/dev/src/tag/1.1.6) (2024-11-17)

### Changed

- Update export-ignore entries

## [1.1.5](https://codefloe.com/celema/dev/src/tag/1.1.5) (2024-11-10)

### Changed

- Update root namespace to `Duon`

## [1.1.4](https://codefloe.com/celema/dev/src/tag/1.1.4) (2024-08-24)

### Changed

- Add `curly_brace_block` to php-cs-fixers `no_extra_blank_lines` rule

## [1.1.3](https://codefloe.com/celema/dev/src/tag/1.1.3) (2024-08-15)
...
## [1.1.2](https://codefloe.com/celema/dev/src/tag/1.1.2) (2024-08-14)

### Changed

- Update namespace

## [1.1.1](https://codefloe.com/celema/dev/src/tag/1.1.1) (2023-11-24)

### Fixed

- Fix attribute type of DocsTestRunner::$dir

## [1.1.0](https://codefloe.com/celema/dev/src/tag/1.1.0) (2023-11-03)

### Added

- Add documentation snippets test runner `docs-test-runner`

## [1.0.2](https://codefloe.com/celema/dev/src/tag/1.0.2) (2023-10-23)
...
## [1.0.1](https://codefloe.com/celema/dev/src/tag/1.0.1) (2023-10-02)
...
## [1.0.0](https://codefloe.com/celema/dev/src/tag/1.0.0) (2023-10-02)
